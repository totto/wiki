...
While the market is starting to get their grips on terminology and categorization of Cloud Computing, Gartner seem to be lost in their own world. Failing to separate Key characteristics, delivery models and deployment models and leveling the field into five attributes, Gartner tries to push us back to _Ground Zero_ :(

<!-- more -->

*A much better approach to see how strongly a cloud solution (or service) adheres to the cloud computing model would be to discuss the combinations in the figure above.*
