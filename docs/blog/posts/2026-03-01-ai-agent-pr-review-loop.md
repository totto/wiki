...
![Recursive Refinement](../../assets/images/blog/ai-agent-pr-review-loop/slide-01.webp)
...
![A routine pull request — 76% reduction in agent tool calls](../../assets/images/blog/ai-agent-pr-review-loop/slide-02.webp)
...
![The first reviewer was not human — Cursor Bugbot vs Claude Code](../../assets/images/blog/ai-agent-pr-review-loop/slide-03.webp)
...
![The autonomous review loop — no back-and-forth drafting, no discussion](../../assets/images/blog/ai-agent-pr-review-loop/slide-04.webp)
...
![Round 1 — hardcoded local path](../../assets/images/blog/ai-agent-pr-review-loop/slide-05.webp)
...
![Round 2 — unrestricted file reading vulnerability](../../assets/images/blog/ai-agent-pr-review-loop/slide-06.webp)
...
![Round 3 — path traversal exploit in the validation logic](../../assets/images/blog/ai-agent-pr-review-loop/slide-07.webp)
...
![Round 4 — API contract violations and argument injection](../../assets/images/blog/ai-agent-pr-review-loop/slide-08.webp)
...
![Round 5 — KCP manifest semantics, protocol design review](../../assets/images/blog/ai-agent-pr-review-loop/slide-09.webp)
...
![Each fix closed an obvious gap to expose a subtler one beneath it](../../assets/images/blog/ai-agent-pr-review-loop/slide-10.webp)
...
![Fixes synchronized across four repositories simultaneously](../../assets/images/blog/ai-agent-pr-review-loop/slide-11.webp)
...
![Heterogeneous AI models catch what single models miss](../../assets/images/blog/ai-agent-pr-review-loop/slide-12.webp)

![The developer transitions from code writer to system supervisor](../../assets/images/blog/ai-agent-pr-review-loop/slide-13.webp)
...
![The code is considerably tighter before a human ever opens the pull request](../../assets/images/blog/ai-agent-pr-review-loop/slide-14.webp)
