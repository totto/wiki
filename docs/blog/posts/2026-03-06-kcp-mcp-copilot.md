...
> **v0.10.0** (released same day as v0.6.0) adds `--generate-all`, `--output-format compact`,
...
v0.10.0 answers that with a complete three-tier static integration. No server. No Node.js
