...
![Prompt Router overview infographic — architecture, performance, and quality data](../../assets/images/blog/prompt-router/prompt-router-infographic.png)
...
![Scaling context without user intervention — the problem and the solution](../../assets/images/blog/prompt-router/slides/slide-02.png)
...
![The injection loop — UserPromptSubmit hook, tokenizer, classifier, top 3 matches, output preamble](../../assets/images/blog/prompt-router/slides/slide-03.png)
...
![The scoring engine: Stage 1 register scan — field weights, generic token suppression, MIN_SCORE threshold](../../assets/images/blog/prompt-router/slides/slide-04.png)
...
![Preventing context bleed — domain siloing with affinity boost and cross-domain penalty; Stage 2 full content scan](../../assets/images/blog/prompt-router/slides/slide-05.png)
...
![Tuning the engine: the path to 13/13 precision — symptom, root cause, engineering fix table](../../assets/images/blog/prompt-router/slides/slide-06.png)
...
![Latency telemetry and the Rust trade-off — waterfall chart, 47ms total, Rust decision matrix](../../assets/images/blog/prompt-router/slides/slide-07.png)
...
![Context lift: does it actually help? — quality measurement table across haiku, sonnet, opus](../../assets/images/blog/prompt-router/slides/slide-08.png)
...
![The LLM behavior spectrum — haiku uses vocab hints, opus synthesizes, sonnet attempts tool execution](../../assets/images/blog/prompt-router/slides/slide-09.png)
...
![The 120-character shift: skill discovery — assumption (vocab injection) vs reality (pointer to files)](../../assets/images/blog/prompt-router/slides/slide-10.png)
...
![Architectural synthesis: the dual-decorator pattern — session warm context vs prompt router JIT](../../assets/images/blog/prompt-router/slides/slide-11.png)
...
![Register documentation — prompt-router (implementation) and exocortex-auto-decorate (philosophy)](../../assets/images/blog/prompt-router/slides/slide-12.png)
