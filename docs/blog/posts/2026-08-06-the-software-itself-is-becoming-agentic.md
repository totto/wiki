...
![Anatomy of a real runtime sub-orchestration: Playbook A calls Playbook B, each with its own ledger and replay story, gated before an explicit human act starts a successor playbook.](/assets/images/blog/the-software-itself-is-becoming-agentic/anatomy-of-a-sub-orchestration.png)

## Infrastructure gets discovered, not planned

![Infrastructure gets discovered, not planned: build the agentic thing, hit the missing layer, build the protocol.](/assets/images/blog/the-software-itself-is-becoming-agentic/infrastructure-gets-discovered.png)
...
![Human judgment doesn't dilute at scale, it amplifies: the human call — which classification rule takes precedence, grounding taxonomy in real fields, catching a CSS collision before it breaks status badges — gets baked into the composed network downstream.](/assets/images/blog/the-software-itself-is-becoming-agentic/human-judgment-amplifies.png)
