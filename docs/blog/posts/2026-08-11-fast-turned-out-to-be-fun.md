...
![Falcon vs. Otter at a glance: domain, build time, core architecture, and key technical hurdle for each](/assets/images/blog/fast-turned-out-to-be-fun/falcon-vs-otter-comparison.png)
...
![Skill, Playbook, Function, and Knowledge/Agent artifact types all feeding into the Sunstone Atlas platform](/assets/images/blog/fast-turned-out-to-be-fun/sunstone-atlas-artifact-types.png)
...
![Propose, review, publish, dispatch — each step Ed25519-signed onto one immutable record](/assets/images/blog/fast-turned-out-to-be-fun/signed-propose-review-publish-dispatch.png)
...
![Human-in-loop and autonomous operation, connected by "track record built" and "deviation" arrows](/assets/images/blog/fast-turned-out-to-be-fun/autonomy-trust-ladder.png)
...
![Engine A (pursuable companies) and Engine B (capital & investors) both sitting on a shared, config-driven core architecture](/assets/images/blog/fast-turned-out-to-be-fun/otter-two-engine-shared-core.png)
...
![The Postgres RLS superuser trap, and the same-day remediation: 0 rows with no role, 0 for non-privileged, exactly 1 for correctly privileged](/assets/images/blog/fast-turned-out-to-be-fun/postgres-rls-superuser-trap.png)
...
![Three leak paths out of the RLS-restricted store: a derived score, a 1:1-mapped dimension value, and an unrestricted plaintext audit log](/assets/images/blog/fast-turned-out-to-be-fun/derived-data-leak-paths.png)
...
![Section title: "The Layer That Makes Parallel Possible — The ExoCortex" — a personal operating layer that sits above and across every venture](/assets/images/blog/fast-turned-out-to-be-fun/the-exocortex-title.png)
...
![Architectural judgment (the human) feeding into the ExoCortex — kcp-toolstack and Synthesis — which both Project Falcon and Project Otter draw on](/assets/images/blog/fast-turned-out-to-be-fun/exocortex-layer-diagram.png)
...
![Skill library growth: 550 entries in May to 1,300+ today, alongside 223 reusable command manifests](/assets/images/blog/fast-turned-out-to-be-fun/skill-library-growth.png)
...
![21 weeks at ~8 merged PRs/day: 1,128 merged pull requests, 7,000+ individual test cases](/assets/images/blog/fast-turned-out-to-be-fun/sustained-pace-1128-prs.png)
