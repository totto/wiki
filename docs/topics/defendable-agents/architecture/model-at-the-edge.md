...
2. The scoring engine ignores prose entirely. It reads the 1–5 variable scores the critic proposed and computes the mean-times-twenty composite. There is no code path from document text to a final total.
