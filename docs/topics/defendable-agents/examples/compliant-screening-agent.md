...
Temporal pinning detects staleness; it does not cure it. The pin will tell you the signals are 40 days old and recommend reanalysis via [drift detection](/topics/defendable-agents/primitives/drift-detection/). It will not fetch fresher data for you. Acting on a stale pursue decision is still your call, now merely a documented one.
