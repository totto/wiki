...
!!! abstract "At a glance"
    Local-first · indexes at 200–300 files/second · sub-second search · multi-layer knowledge graphs · **65+** CLI commands · **11** MCP tools · **4,300+** tests · Notion as a first-class workspace source · Java 21 · [github.com/exoreaction/Synthesis](https://github.com/exoreaction/Synthesis)
